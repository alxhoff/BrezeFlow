...
class Ui_DialogSettings(object):
    def setupUi(self, DialogSettings):
        ...
        self.checkBoxBinderTransaction.setObjectName(
            "checkBoxBinderTransaction")
        ...
        self.radioButtonMultiProcessing.setObjectName(
            "radioButtonMultiProcessing")
        ...
        self.pushButtonSysloggerSetup = QtWidgets.QPushButton(
            self.pageSyslogger)
        ...
        self.pushButtonSysloggerStart = QtWidgets.QPushButton(
            self.pageSyslogger)
        ...
        self.pushButtonSysloggerStop = QtWidgets.QPushButton(
            self.pageSyslogger)
        ...
        self.pushButtonSysloggerFinish = QtWidgets.QPushButton(
            self.pageSyslogger)
        self.pushButtonSysloggerFinish.setObjectName(
            "pushButtonSysloggerFinish")
        ...
        self.lineEditSyslogPullFilename.setObjectName(
            "lineEditSyslogPullFilename")
        ...
        self.lineEditConvertDestination.setObjectName(
            "lineEditConvertDestination")
        self.horizontalLayout_3.addWidget(self.lineEditConvertDestination)
        self.pushButtonFileToConvertDestination = QtWidgets.QPushButton(
            self.frame_3)
        ...
        self.horizontalLayout_3.addWidget(
            self.pushButtonFileToConvertDestination)
    ...
    def retranslateUi(self, DialogSettings):
        ...
        self.label.setText(
            _translate("DialogSettings", "Default Application Name"))
        ...
        self.label_13.setText(
            _translate("DialogSettings", "Speed Optimizations"))
        self.radioButtonNonthreaded.setText(
            _translate("DialogSettings",
                       "No threading (application will block)"))
        ...
        self.pushButtonSysloggerSetup.setText(
            _translate("DialogSettings", "Setup"))
        self.pushButtonSysloggerStart.setText(
            _translate("DialogSettings", "Start"))
        self.pushButtonSysloggerStop.setText(
            _translate("DialogSettings", "Stop"))
        self.pushButtonSysloggerFinish.setText(
            _translate("DialogSettings", "Finish"))
        ...
        self.pushButtonSysloggerPull.setText(
            _translate("DialogSettings", "Pull"))
        self.lineEditSyslogPullFilename.setPlaceholderText(
            _translate("DialogSettings", "New file name"))
        self.label_9.setText(
            _translate("DialogSettings", "Process Tracecmd<br>File"))
        ...
        self.lineEditConvertDestination.setPlaceholderText(
            _translate("DialogSettings", "Destination folder"))
        self.pushButtonConvertTrace.setText(
            _translate("DialogSettings", "Process"))
        self.label_10.setToolTip(
            _translate("DialogSettings",
                       "CPU to run/pin the logging thread on"))
        self.label_10.setText(
            _translate("DialogSettings", "Logging Thread <br>CPU"))
        ...
        self.checkBoxCPUInfo.setToolTip(
            _translate("DialogSettings",
                       "Log CPU system/user/idle time and state"))
        self.checkBoxCPUInfo.setText(
            _translate("DialogSettings", "CPU Information"))
        ...
        self.checkBoxPower.setToolTip(
            _translate("DialogSettings",
                       "Log Power consumption via ina231 sensors"))
        self.checkBoxPower.setText(_translate("DialogSettings",
                                              "INA231 Power"))
