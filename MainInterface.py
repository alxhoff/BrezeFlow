...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frameAvailableGovernors = QtWidgets.QFrame(self.frameGovernorOptions)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.frameAvailableGovernors.sizePolicy().hasHeightForWidth())
        self.frameAvailableGovernors.setSizePolicy(sizePolicy)
        self.frameAvailableGovernors.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameAvailableGovernors.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameAvailableGovernors.setObjectName("frameAvailableGovernors")
        self.verticalLayout_13 = QtWidgets.QVBoxLayout(self.frameAvailableGovernors)
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.label_12 = QtWidgets.QLabel(self.frameAvailableGovernors)
        ...
        self.verticalLayout_13.addLayout(self.verticalLayoutGovernors)
        self.verticalLayout_12.addWidget(self.frameAvailableGovernors, 0, QtCore.Qt.AlignHCenter)
