...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelCurrentLittleGovernor = QtWidgets.QLabel(self.frame_2)
        self.labelCurrentLittleGovernor.setAutoFillBackground(False)
        self.labelCurrentLittleGovernor.setFrameShape(QtWidgets.QFrame.Panel)
        self.labelCurrentLittleGovernor.setAlignment(QtCore.Qt.AlignCenter)
        self.labelCurrentLittleGovernor.setObjectName("labelCurrentLittleGovernor")
        self.verticalLayout_15.addWidget(self.labelCurrentLittleGovernor)
        self.label_37 = QtWidgets.QLabel(self.frame_2)
        self.label_37.setObjectName("label_37")
        self.verticalLayout_15.addWidget(self.label_37)
        self.labelCurrentBigGovernor = QtWidgets.QLabel(self.frame_2)
        self.labelCurrentBigGovernor.setAutoFillBackground(False)
        self.labelCurrentBigGovernor.setFrameShape(QtWidgets.QFrame.Panel)
        self.labelCurrentBigGovernor.setAlignment(QtCore.Qt.AlignCenter)
        self.labelCurrentBigGovernor.setObjectName("labelCurrentBigGovernor")
        self.verticalLayout_15.addWidget(self.labelCurrentBigGovernor)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditAppPID.setPlaceholderText(_translate("MainWindow", "Input PID for hard-to-find apps"))
        ...
        self.label_36.setText(_translate("MainWindow", "LITTLE"))
        self.labelCurrentLittleGovernor.setText(_translate("MainWindow", "None"))
        self.label_37.setText(_translate("MainWindow", "big"))
        self.labelCurrentBigGovernor.setText(_translate("MainWindow", "None"))
        ...
        self.checkBoxTestAutomationPrompt.setText(_translate("MainWindow", "Prompt between tests"))
